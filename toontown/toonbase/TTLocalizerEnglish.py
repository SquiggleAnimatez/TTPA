...
AIStartDefaultDistrict = 'Nuttyriver'
Cog = 'Cog'
Cogs = 'Cogs'
ACog = 'a Cog'
TheCogs = 'The Cogs'
...
QuestsDefaultComplete = ('Thank you so much for your help, _avName_!', 'Great job, _avName_! Take this reward...', 'Wonderful job, _avName_! Here is your reward...')
...
QuestDialogDict = {
 ...
 # Task Nine
 2090: {QUEST:  "Thank goodness you are here _avName_!\x07Sticky Lou is in desperate need of assistance with an unexpected wave of Cogs surrounding his shop!\x07Please go to him and help him with whatever he needs._where_"}, # Flippy to Sticky Lou
 ...
 #AA Task One
 3000: {QUEST: "You must be new around here?\x07_toNpcName_ could use help from a new toon like you._where_"},
 3001: {GREETING: '',
...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 "You are about to report that %s has created a name that does not follow the Project Anvil rules.",
...
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Project Anvil product.'
...
SuitAttackTaunts = {'AcidRain': ["It's sulfur you.",
 ...
 'Legalese': ['You must cease and desist.',
              ...
              "The opinions expressed in this attack are not those of Project Anvil.",
...
FriendInviterPlayerFriendInfo = 'A friend across the Project Anvil network'
...
LauncherStartingMessage = "Starting Project Anvil... "
...
LauncherConnectProxyAttempt = 'Connecting to Project Anvil: %s (proxy: %s) attempt: %s'
LauncherConnectAttempt = 'Connecting to Project Anvil: %s attempt %s'
LauncherDownloadServerFileList = 'Updating Project Anvil...'
LauncherCreatingDownloadDb = 'Updating Project Anvil...'
LauncherDownloadClientFileList = 'Updating Project Anvil...'
LauncherFinishedDownloadDb = 'Updating Project Anvil... '
LauncherStartingGame = 'Starting Project Anvil...'
LauncherRecoverFiles = 'Updating Project Anvil. Recovering files...'
LauncherCheckUpdates = 'Checking for updates for ' + LauncherProgress
LauncherVerifyPhase = 'Updating Project Anvil...'
...
MusicTtpaTheme = 'The Project Anvil Theme'
...
LoaderLabel = 'Loading Project Anvil...'
...
BetaCertificateItem = 'A Project Anvil Beta Certificate'
...
PopupTouchControls = 'You are using the \1textShadow\1EXPERIMENTAL\2 touch controls. These are very early in development and may be buggy. Please report any issues to the team. Thanks, and enjoy Project Anvil!'
PopupAlphaDisclaimer = '\1textShadow\1Disclaimer:\2\nThis is an BETA build of Project Anvil! Things that are in game may be subject to change! There is some incomplete content as well, so stay tooned for the updated content! Thanks for participating in Project Anvil\' Beta!'
...
QuestScriptTutorialBlocker_7 = "It's called the SpeedChat Plus button. You need to turn on Speedchat Plus in your Account Manager on the Project Anvil Website to use it."
...
QuestScript600_1 = "Welcome to Toontown: Project Anvil!"
...
QuestScript600_6 = "Have fun in Toontown: Project Anvil!"
...
CagedToonDrop = ["Great job!  You're tiring him!",
 "Don't let up!  He's on the move!",
 'You guys are doing great! Keep it up!',
 "Fantastic!  You've got him on the ropes now!"]
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Project Anvil folder on your computer.',
               ...
               'You never need to save your Toontown progress. The Project Anvil servers continually save all the necessary information.',
