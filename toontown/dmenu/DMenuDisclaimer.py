...
class DMenuDisclaimer(DirectObject):
    ...
    def __init__(self):
        ...
        disclaimerText = "Project Anvil is a not-for-profit fanmade parody made under Fair Use. Project Anvil is not affiliated with The Walt Disney Company and/or the Disney Interactive Media Group (collectively referred to as \"Disney\") by clicking I agree you hereby agree that you acknowledge this fact."
